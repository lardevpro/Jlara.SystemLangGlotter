        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    UserId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    SecondsPractice = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    SuccessesPronunciation = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    SuccessesWriting = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    ProgressLevelCurrent = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    Level = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ErrorsPronunciation = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    ErrorsWriting = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    MotivationalPhrase = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ExtraProperties = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ConcurrencyStamp = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false)
